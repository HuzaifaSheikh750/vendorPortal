                                    ...
                                    <nav className="menu-nav">
                                        ...
                                        <div className="navbar-wrap main-menu d-none d-lg-flex">
                                            <ul className="navigation">
                                                ...
                                                <li className="active"><Link href="#">Features</Link>
                                                    {/* <ul className="sub-menu">
                                                ...
                                                <li className=""><Link href="https://www.kaispe.com/resources/blogs/" target="_blank">Blogs</Link>
                                                    {/* <ul className="sub-menu">
                                                ...
                                                <li className=""><Link href="/contact">contacts</Link></li>
                                            </ul>
                                        </div>
                                        <div className="header-action d-none d-md-block">
                                            <ul className="list-wrap">
                                                {/* <li className="header-search" onClick={handleSearch}><Link href="#"><i className="flaticon-search" /></Link></li> */}
                                                <li className="header-btn"><Link href="https://kspcs.powerappsportals.com/customer-landing/" target="_blank" className="btn btn-two">Support Portal</Link></li>
                                            </ul>
                                        </div>
                                    </nav>
                                </div>
