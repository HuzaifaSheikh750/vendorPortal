    ...
    return (
        <>
            <ul className="navigation">
                ...
                <li className="menu-item-has-children"><Link href="https://www.kaispe.com/resources/blogs/" target="_blank">Blog</Link>
                ...
                <li className="menu-item-has-children"><Link href="/pricing">Pricing</Link>
