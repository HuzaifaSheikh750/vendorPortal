                        ...
                        <div className="col-lg-6">
                            <div className="skill-wrap wow fadeInRight" data-wow-delay=".2s">
                                <div className="section-title-two mb-15">
                                    ...
                                    <h2 className="title">Streamlined Procurement Workflow Vendor Management Portal</h2>
                                </div>
                                <p>Our Vendor Portal streamlines the procurement workflow, ensuring every 
                                    step, from product requests to invoicing, is 
                                    optimized for efficiency. The portal offers 
                                    an array of features to facilitate a smooth 
